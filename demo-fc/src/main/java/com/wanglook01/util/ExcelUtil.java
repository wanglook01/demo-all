...
public class ExcelUtil {
    ...
    public static class D3DataExcelListener implements ReadListener<D3Data> {
    ...
    public static List<D3Data> getHistoryData() {
        URL resource = ExcelUtil.class.getClassLoader().getResource("history.xlsx");
        String path = resource.getPath();
        D3DataExcelListener listener = new D3DataExcelListener();
        // 读取全部sheet
        EasyExcel.read(path, D3Data.class, listener).doReadAll();
        //整理成需要的格式
